...
dfb <-
  ...
  clean_names()
# dictionary
# https://raw.githubusercontent.com/rfordatascience/tidytuesday/refs/heads/main/data/2025/2025-09-02/readme.md
...
dfas <- dfa[sample(nrow(dfa), 1000, replace = FALSE), ]

dfas |> 
  group_by(scientific_name) |> 
  summarise(n = n()) |> 
  arrange(desc(n)) |> 
  ggplot(aes(x = scientific_name, y = n)) + 
  geom_col()
